...
| CI cross-platform fixture | Ubuntu + Windows, Python 3.12 | Byte-identical `gate-v2`, comparison, explanation, and fixture artifacts | Canonical serialization is checked across supported CI operating systems |
