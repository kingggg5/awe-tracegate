...
| [Public upstream compatibility report](docs/validation/itsdangerous-compatibility-2026-08-11.md) | `pallets/itsdangerous` at an exact public commit | `297 passed`; exact AWE replay `valid` | A read-only evidence workflow can be reproduced alongside a real upstream test suite |
